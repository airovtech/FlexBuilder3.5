package com.maninsoft.smart.formeditor.view.format
{
	...
	public class DepartmentFieldView extends AbstractFormatView implements IFormatView
	{
		...
		public function DepartmentFieldView()
		{
			super();
		...
		override public function get formatType():FormatType {
			return FormatTypes.departmentField;
		}
	}
}
...
package com.maninsoft.smart.modeler.xpdl.components
{
	...
	/**
	 * TaskFormPanel 의 head view
	 */
	public class TaskFormPanelHead extends Sprite implements IDraggable {
		...
		/** Constructor */
		public function TaskFormPanelHead(width: int, height: int) {
			super();		
		...
		public function getDragTracker(event: MouseEvent): DragTracker {
			return new PanelDragTracker(parent as TaskFormPanel);
		}

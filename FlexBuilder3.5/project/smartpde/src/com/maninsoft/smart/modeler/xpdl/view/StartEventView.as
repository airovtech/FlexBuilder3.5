...
package com.maninsoft.smart.modeler.xpdl.view
{
	...
	public class StartEventView extends EventView {
		...
		/** Constructor */
		public function StartEventView() {
			super();
		}
		...
		override public function draw(): void {
			...
			// startActivity
			if (startActivity) {
				if (!_startActivityIcon) {
					_startActivityIcon = new StartActivityIcon(this);
					addChild(_startActivityIcon);
				}
				
				_startActivityIcon.x = nodeWidth/3;
				_startActivityIcon.y = 0-_startActivityIcon.height*2/3;
			}
			else if (_startActivityIcon) {
				removeChild(_startActivityIcon);
				_startActivityIcon = null;
			}

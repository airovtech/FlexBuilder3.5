package com.maninsoft.smart.workbench.command
{
	...
	public class AddProcessCommand extends Command
	{
		...
		public function AddProcessCommand(pack:SWPackage, prcName:String, resultHandler:Function, faultHandler:Function, undoHandler:Function) {
			super("프로세스 추가");
		...
		public function executeHandler(event:MISPackageEvent):void{
			swProcess = event.swProcess; 
			this.resultHandler(event);
		}

		public override function undo():void{
			WorkbenchConfig.repoService.removeProcess(this.pack, swProcess, (undoHandler == null)?resultHandler:undoHandler, faultHandler);
		}		
	}
}
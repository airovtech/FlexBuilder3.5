...
package com.maninsoft.smart.ganttchart.editor.property
{
	 ...
	 */
	public class DateTimeClearPropertyInfo_old extends PropertyInfo	{
		
		private var _editor: DateTimeClearPropertyEditor;
		...
		/** Constructor */
		public function DateTimeClearPropertyInfo(id: String, displayName: String, 
		...
		override public function getEditor(source: IPropertySource): IPropertyEditor {
			...
			if (!_editor) {
				_editor = new DateTimeClearPropertyEditor();
			}

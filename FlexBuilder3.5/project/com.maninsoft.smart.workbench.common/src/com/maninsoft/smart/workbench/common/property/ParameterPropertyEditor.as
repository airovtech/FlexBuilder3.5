package com.maninsoft.smart.workbench.common.property
{
	 ...
	 */
	public class ParameterPropertyEditor extends ButtonPropertyEditor{
		...
		/** Constructor */
		public function ParameterPropertyEditor() {
			super();
		}

		override protected function childrenCreated():void{
			super.childrenCreated();			
			this.buttonIcon =  PropertyIconLibrary.parameterSettingIcon;
		}
